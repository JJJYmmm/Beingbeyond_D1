...
def start_retargeting(queue: multiprocessing.Queue, robot_dir: str, config_path: str):
    ...
    while True:
        ...
        if joint_pos is None:
            ...
            print(retargeting.optimizer.target_joint_names, retargeting.joint_limits)
...
def main(
    robot_name: RobotName, retargeting_type: RetargetingType, hand_type: HandType=HandType.right, camera_path: Optional[str] = None
):
    """
